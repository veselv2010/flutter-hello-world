...
class Items {
  ...
  Items({String addedAt, Track track}) {
...
class Track {
  ...
  Track(
    ...
    this._availableMarkets = availableMarkets;
  ...
  List<String> get availableMarkets => _availableMarkets;
  set availableMarkets(List<String> availableMarkets) =>
  ...
  Track.fromJson(Map<String, dynamic> json) {
    ...
    _availableMarkets = json['available_markets'].cast<String>();
  ...
  Map<String, dynamic> toJson() {
    ...
    data['available_markets'] = this._availableMarkets;
