...
class _PlayingWidgetState extends State<PlayingWidget> {
                ...
                Container(
                  child: Column(
                    children: [
                      Container(
                        child: ClipRRect(
                            child: _getAlbumCover(snapshot.data.albumCoverUrl),
  ...
  Icon _getPlaybackStateIcon(bool isPlaying) => isPlaying
      ? Icon(Icons.pause, size: 64)
      : Icon(Icons.play_arrow, size: 64);

  Image _getAlbumCover(String url) =>
      url == null ? Image.asset('assets/emptyImage.jpg') : Image.network(url);
}
